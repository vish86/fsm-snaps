 ...
 * @author svatada
 */
@XmlType(name = "CCVResultCodeType", namespace = "com/firstdata/Merchant/gmfV2.08")
@XmlEnum
public enum CCVResultCodeType {

    @XmlEnumValue("Match")
    MATCH("Match"), @XmlEnumValue("NoMtch")
    NO_MTCH("NoMtch"), @XmlEnumValue("NotPrc")
    NOT_PRC("NotPrc"), @XmlEnumValue("NotPrv")
    NOT_PRV("NotPrv"), @XmlEnumValue("NotPrt")
    NOT_PRT("NotPrt"), @XmlEnumValue("Unknwn")
    UNKNWN("Unknwn");

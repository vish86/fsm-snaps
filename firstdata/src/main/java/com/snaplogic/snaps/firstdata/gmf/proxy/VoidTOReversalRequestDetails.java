...
@XmlType(name = "VoidTOReversalRequestDetails", namespace = "com/firstdata/Merchant/gmfV2.08",
        propOrder = { "commonGrp", "billPayGrp", "altMerchNameAndAddrGrp", "cardGrp", "pinGrp",
                "addtlAmtGrp", "emvGrp", "taGrp", "offerGrp", "ecommGrp", "secrTxnGrp", "visaGrp",
                "mcGrp", "dsGrp", "amexGrp", "ebtGrp", "debitGrp", "purchCardlvl2Grp",
                "custInfoGrp", "orderGrp", "storedValueGrp", "origAuthGrp", "prodCodeGrp",
                "prodCodeDetGrp" })

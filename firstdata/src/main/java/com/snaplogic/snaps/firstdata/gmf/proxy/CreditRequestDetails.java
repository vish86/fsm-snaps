 ...
 *         &lt;element name="CustInfoGrp" type="{com/firstdata/Merchant/gmfV1.1}CustInfoGrp" minOccurs="0"/>
...
@XmlType(name = "CreditRequestDetails", namespace = "com/firstdata/Merchant/gmfV1.1", propOrder = {
    "commonGrp",
    "billPayGrp",

...
@XmlType(name = EBT_REQUEST_DETAILS, namespace = NAMESPACE, propOrder = { COMMON_GRP,
        ALT_MERCH_NAME_AND_ADDR_GRP, CARD_GRP, PIN_GRP, ADDTL_AMT_GRP, TA_GRP, EBT_GRP })
public class EBTRequestDetails {
    ...
    @XmlElement(name = EBT_GRP_ELT, namespace = NAMESPACE)

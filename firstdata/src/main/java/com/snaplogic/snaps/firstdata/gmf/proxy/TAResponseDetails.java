...
import static com.snaplogic.snaps.firstdata.gmf.proxy.Constants.TA_RESPONSE_DETAILS_NAME;
...
@XmlType(name = TA_RESPONSE_DETAILS_NAME, namespace = NAMESPACE, propOrder = { COMMON_GRP, TA_GRP,
        RESP_GRP })

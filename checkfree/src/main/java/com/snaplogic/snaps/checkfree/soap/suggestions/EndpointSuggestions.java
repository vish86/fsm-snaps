...
import static com.snaplogic.snaps.checkfree.soap.suggestions.Messages.SERVICE_NAME_MUST_BE_DEFINED_FIRST;
...
public class EndpointSuggestions extends AbstractSuggestions {
    ...
    public EndpointSuggestions(final IntrospectionService introspectionService, final String nodeKey) {

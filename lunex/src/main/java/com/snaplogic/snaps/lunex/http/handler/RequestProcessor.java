...
import static com.snaplogic.snaps.lunex.constants.Constants.QUOTE;
...
public class RequestProcessor {
    ...
    private String getTimeJson(
        ...
        response =
            OPENTAG + QUOTE + RResource.GetTime + QUOTE + COLON + QUOTE
                + response.replaceAll(REGEX, "")
                    .substring(4) + QUOTE + CLOSETAG;
        return response;
    }
}
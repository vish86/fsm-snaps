...
public class Messages {
    ...
    public static final String FIELD_NAME_DESC = "Lunex resource field name to be "
        + "used in the output map data.If left blank, the Field path will be " + "used instead.";
    ...
    public static final String JSON_PARSING_RESOLUTION = "Please check reponse returned "
        + "from the service";
    public static final String MALFORMEDURL_ERROR_REASON =
        "The URL string is not parseable or contains an unsupported protocol";
    public static final String MALFORMEDURL_ERROR_RESOLUTION =
        "Possible common mistakes includes specifying an invalid protocol,leaving out the protocal and colun character.";
    public static final String HTTP_ERROR_REASON =
        "Some thing went wrong while building the HTTP request or provided input data has invalid information";

...
public class ServiceURIInfo {
	 ...
	 */
	public final static ImmutableMap<String, String> CR_URI_LIST = new ImmutableMap.Builder<String, String>()
	        ...
	        .put(CResource.Account.toString(),
	                "/pos/sellers/{SELLER}/pins/?phone_type={PHONETYPE}&lang="
	                        + "{LANG}&notify={NOTIFY}")
	        .put(CResource.VoidTx.toString(),
	                "/pos/sellers/{SELLER}/trans/{TXID}?notify={NOTIFY}")
	...
	public final static ImmutableMap<String, String> RR_URI_LIST = new ImmutableMap.Builder<String, String>()
	        ...
	        .put(RResource.GetOrderStatus.toString(),
	                "/pos/sellers/{SELLER}/orderstatus/{CID}")
	        ...
	        .put(RResource.ListDidByState.toString(),
	                "/pos/sellers/{SELLER}/did/?state={STATE}&type={TYPE}"
	                        + "&lang={LANG}")
	        .put(RResource.ListProduct.toString(),
	                "/pos/sellers/{SELLER}/products/")
	        .put(RResource.ListRegisterPhone.toString(),
	                "/pos/sellers/{SELLER}/pins/{PIN}/registerphones/?"
	                        + "passcode={PASSCODE}")
	        .put(RResource.ListSpeedDial.toString(),
	                "/pos/sellers/{SELLER}/pins/{PIN}/speeddials/?passcode"
	                        + "={PASSCODE}")
	 ...
	 */
	public final static ImmutableMap<String, String> UR_URI_LIST = new ImmutableMap.Builder<String, String>()
	        .put(UResource.PostOrder.toString(),
	                "/pos/sellers/{SELLER}/orders/{CID}?promo_phone="
	                        + "{PROMOPHONE}")
	        .put(UResource.UpdateAccount.toString(),
	                "/pos/sellers/{SELLER}/pins/{PIN}")
	 ...
	 */
	public final static ImmutableMap<String, String> DR_URI_LIST = new ImmutableMap.Builder<String, String>()
	        ...
	        .put(DResource.RemoveCustomer.toString(), "").build();

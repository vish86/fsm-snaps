...
import com.snaplogic.snaps.lunex.constants.Constants.DResource;
import com.snaplogic.snaps.lunex.constants.Constants.RResource;
import com.snaplogic.snaps.lunex.constants.Constants.UResource;

/**
 * This class holds all the resource specific URI information.
 *
 * @author svatada
 */
...
public class ServiceURIInfo {
     ...
     */
    public final static ImmutableMap<String, String> CR_URI_LIST =
     ...
     */
    public final static ImmutableMap<String, String> RR_URI_LIST =
        new ImmutableMap.Builder<String, String>().put(RResource.GetAccount.toString(),
            ...
            .put(
                RResource.ListTransactions.toString(),
            ...
            .put(RResource.TopUpOrder.toString(),
                "/pos/sellers/{seller}/orders/{ORDER}?sku={SKU}&phone" + "={PHONE}&amount={AMOUNT}")
            .build();

    /*
     * PUT/Update Resource operation supported resource list
     */
    public final static ImmutableMap<String, String> UR_URI_LIST =
        new ImmutableMap.Builder<String, String>().put(UResource.PostOrder.toString(),
     ...
     */
    public final static ImmutableMap<String, String> DR_URI_LIST =
        new ImmutableMap.Builder<String, String>().put(DResource.DeleteRegisterPhone.toString(),

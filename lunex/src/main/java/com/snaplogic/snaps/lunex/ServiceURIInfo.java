...
public class ServiceURIInfo {
    static final ImmutableMap<String, Integer> REQ_BODY_PARAM_INFO = new ImmutableMap.Builder<String, Integer>().put(
            "AutoRefillUpdatedBy", 0)
            .put("AccessPhone", 0)
     ...
     */
    static final ImmutableMap<String, ImmutableSet<String>> RR_PARAM_LIST = new ImmutableMap.Builder<String, ImmutableSet<String>>().put(
            RResource.GetAccount.toString(),
     ...
     */
    static final ImmutableMap<String, ImmutableSet<String>> UR_PARAM_LIST = new ImmutableMap.Builder<String, ImmutableSet<String>>().put(
            UResource.PostOrder.toString(),
            new ImmutableSet.Builder<String>().add(SELLER).add(CID).add(PROMO_PHONE).build())
     ...
     */
    static final ImmutableMap<String, ImmutableSet<String>> DR_PARAM_LIST = new ImmutableMap.Builder<String, ImmutableSet<String>>().put(
            DResource.DeleteRegisterPhone.toString(),
            new ImmutableSet.Builder<String>().add(SELLER).add(PIN).add(REGISTERPHONE).build())
     ...
     */
    static final ImmutableMap<String, String> CR_URI_LIST = new ImmutableMap.Builder<String, String>().put(
            CResource.NewOrder.toString(),
     ...
     * GET/Read Resource operation supported resource list
     */
    static final ImmutableMap<String, String> RR_URI_LIST = new ImmutableMap.Builder<String, String>().put(
            RResource.GetAccount.toString(), "/pos/sellers/{SELLER}/pins/{PIN}?passcode={PASSCODE}")
     ...
     */
    static final ImmutableMap<String, String> UR_URI_LIST = new ImmutableMap.Builder<String, String>().put(
            UResource.PostOrder.toString(),
            ...
            .put(UResource.UpdateSpeedDial.toString(),
                    "/pos/sellers/{SELLER}/pins/{PIN}/speeddials/")
            .build();
    /*
     * DELETE/Delete Resource operation supported resource list
     */
    static final ImmutableMap<String, String> DR_URI_LIST = new ImmutableMap.Builder<String, String>().put(
            DResource.DeleteRegisterPhone.toString(),
            "/pos/sellers/{SELLER}/pins/{PIN}/registerphones/{REGISTERPHONE}")
            .put(DResource.DeleteSpeedDial.toString(),
                    "/pos/sellers/{SELLER}/pins/{PIN}/speeddials/{SPEEDDIAL}")
            .put(DResource.RemoveCustomer.toString(),
                    "/SetupService/sellers/{SELLER}/sku/{SKU}/phone/{PHONE}")
            .build();
}
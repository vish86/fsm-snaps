...
public class ServiceURIInfo {
     ...
     */
    final static ImmutableMap<String, String> CR_URI_LIST =
     ...
     */
    final static ImmutableMap<String, String> RR_URI_LIST =
     ...
     */
    final static ImmutableMap<String, String> UR_URI_LIST =
     ...
     */
    final static ImmutableMap<String, String> DR_URI_LIST =

...
class Messages {
    ...
    static final String ILLEGAL_ARGS_EXE = "Indicates that, the input has been passed an illegal or inappropriate value.";
    static final String INVOCATION_TARGET_EXE = "Trying to execute the unknow function call or method parameter types were wrong.";
}
...
public class ReadTest extends ApiTest {
    @TestFixture(snap = Read.class, outputs = "out1", errors = "err1", input = "data/read/input_valid_GetTxDetailsData.json", properties = "data/read/property_GetTxDetails.json")
    ...
    @TestFixture(snap = Read.class, input = "data/read/input_invalid_GetTxDetailsData.json", outputs = "out1", errors = "err1", properties = "data/read/property_GetTxDetails.json")
    ...
    @TestFixture(snap = Read.class, outputs = "out1", errors = "err1", input = "data/read/input_valid_GetNotificationsData.json", properties = "data/read/property_GetNotifications.json")
    ...
    @TestFixture(snap = Read.class, input = "data/read/input_invalid_GetNotificationsData.json", outputs = "out1", errors = "err1", properties = "data/read/property_GetNotifications.json")

...
public class CreateTest extends ApiTest {
    @TestFixture(snap = Create.class, outputs = "out1", errors = "err1",
            input = "data/create/input_valid_CreateScTxData.json",
            properties = "data/create/property_CreateScTx.json")
...
>>>>>>> 84f3989399e926d18a457a9135dfcc3c848ac39a
    ...
    @TestFixture(snap = Create.class, outputs = "out1", errors = "err1",
            input = "data/create/input_invalid_CreateScTxData.json",
            properties = "data/create/property_CreateScTx.json")
...
>>>>>>> 84f3989399e926d18a457a9135dfcc3c848ac39a
    ...
    @TestFixture(snap = Create.class, outputs = "out1", errors = "err1",
            input = "data/create/input_valid_NotifConfirmData.json",
            properties = "data/create/property_NotifConfirm.json")
    ...
    @TestFixture(snap = Create.class, outputs = "out1", errors = "err1",
            input = "data/create/input_invalid_NotifConfirmData.json",
            properties = "data/create/property_NotifConfirm.json")
